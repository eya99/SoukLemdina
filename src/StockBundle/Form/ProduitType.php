...
class ProduitType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('categorie',ChoiceType::class,array( 'choices'  => array('Arts de la table'=>'Arts de la table','Habillement'=>'Habillement','Bijoux'=>'Bijoux','Produits du Terroir'=>'Produits du Terroir','Maroquinerie'=>'Maroquinerie','Décoration'=>'Décoration'),'label' => 'Catégorie','attr'   =>  array('class'   => 'form-control')))
            ->add('prix',null,array('label' => 'Prix','attr'   =>  array('class'   => 'form-control')))
            ->add('promotion',RangeType::class,array('label' => 'Pourcentage de promotion','attr'   =>  array('min' =>0, 'max' =>100,'class'=>'range_01',)))
