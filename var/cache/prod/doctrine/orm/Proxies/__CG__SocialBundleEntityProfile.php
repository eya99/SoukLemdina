...
namespace Proxies\__CG__\SocialBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Profile extends \SocialBundle\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'id', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'idUser', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'tagline', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'aboutMe', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'image', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'imageFile', '' . "\0" . 'SocialBundle\\Entity\\Profile' . "\0" . 'updatedAt'];
        }
